...
if (!isset($_REQUEST['bAceptar'])) {
    ...
    if (!isset($_FILES['imagen'])) {
        ...
        if (($_FILES['imagen']['error'] != 0)) {
            ...
            //Extraemos la extensión del fichero, desde el último punto. Si hubiese doble extensión, no lo tendría en cuenta.
            ...
            if ($tamanyoFile > $max_file_size) {
                $errores["imagen"] = "La imagen debe de tener un tamaño inferior a 50 mb";
            }
